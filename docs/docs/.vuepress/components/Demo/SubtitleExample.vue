...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.playerConfig['height'] = '315px';
            this.playerConfig['src'] = '/media/subtitleSource.mp4';
            this.playerConfig['poster'] = 'https://muiplayer.oss-cn-shanghai.aliyuncs.com/static/image/subtitle_poster.jpg';
            this.playerConfig['subtitle'] = {
                tracks:[
                        {
                            kind:'subtitles',
