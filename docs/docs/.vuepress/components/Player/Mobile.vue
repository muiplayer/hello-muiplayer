<template>
    <main>
        <div id="mui-player" style="margin-top:11px;max-width: 100%;">
...
<script>
    ...
    import { pluginMobile } from '../../public/js/plugins'
    ...
    export default {
        ...
        mounted() {
            this.playerConfig = Object.assign(pluginMobile, config);
            
            this.playerConfig['lang'] = this.$lang.indexOf('en') > -1 ? 'en' : 'zh-cn';
            this.playerConfig['width'] = '591px';

            let muiplayer = new MuiPlayer(this.playerConfig);

            muiplayer.once('ready', () => {
                muiplayer.toggleControls(true).closeTimer();
            });
